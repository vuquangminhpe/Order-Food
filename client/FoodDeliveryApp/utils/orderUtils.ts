 ...
 */
export const getNextPossibleStatuses = (currentStatus: any) => {
 ...
 */
export const formatOrderDate = (dateString: string | number | Date) => {
 ...
 */
export const getRelativeTime = (dateString: string | number | Date) => {
  const date = new Date(dateString);
  const now = new Date();
