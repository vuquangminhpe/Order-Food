            ...
            <View style={styles.summaryHeaderRow}>
              ...
              <View
                style={[
                  ...
                  {
                    backgroundColor:
                      parseFloat(analytics.revenue.change) >= 0
              ...
              >
                ...
                >
                  {Math.abs(parseFloat(analytics.revenue.change))}%
                </Text>
              </View>
            </View>
            ...
            <View style={styles.summaryHeaderRow}>
              ...
              <View
                style={[
                  ...
                  {
                    backgroundColor:
                      parseFloat(analytics.orders.change) >= 0
                        ? theme.colors.success + "20"
                        : theme.colors.error + "20",
                  },
                ]}
              >
                ...
                >
                  {Math.abs(parseFloat(analytics.orders.change))}%
                </Text>
              </View>
            </View>
            <Text style={[styles.summaryValue, { color: theme.colors.text }]}>
