...
const AddEditMenuItemScreen = ({ route, navigation }: any) => {
  ...
  const deleteOptionItem = (optionIndex: number, itemIndex: any) => {
    const updatedOptions = [...menuItem.options];
    updatedOptions[optionIndex].items = updatedOptions[
      optionIndex
    ].items.filter((_: any, i: any) => i !== itemIndex);
    handleChange("options", updatedOptions);
  };
                    ...
                    >
                      ...
                      <View style={styles.optionForm}>
                        <TextInput
                          ...
                          onChangeText={(text) =>
                            updateOption(index as number, "title", text)
                          }
                        />
                        ...
                        <View style={styles.optionSwitches}>
                          <View style={styles.optionSwitch}>
                            ...
                            <Switch
                              ...
                              onValueChange={(value) =>
                                updateOption(index as number, "required", value)
                              }
                              trackColor={{
                                false: theme.colors.gray,
                                true: theme.colors.primary + "80",
                          ...
                          <View style={styles.optionSwitch}>
                            ...
                            <Switch
                              ...
                              onValueChange={(value) =>
                                updateOption(index as number, "multiple", value)
                              }
                              trackColor={{
                                false: theme.colors.gray,
                                true: theme.colors.primary + "80",
                        ...
                        {option.items.map(
                          (
                            item: {
                              ...
                              price: { toString: () => string | undefined };
                            },
