...
const EditRestaurantProfileScreen = ({ navigation }) => {
  ...
  const handleSelectLogo = async () => {
    ...
    try {
      ...
      if (result.assets && result.assets.length > 0) {
        ...
        setLogoImage(selectedImage.uri);
      }
    } catch (error) {
  ...
  const handleSave = async () => {
    try {
      ...
      if (coverImage && coverImage !== restaurant.coverImage) {
        await restaurantService.uploadRestaurantImages(restaurantId, "cover", [
          coverImage,
        ]);
      }
      ...
      if (galleryImages.length > 0) {
        const newImages = galleryImages.filter(
          (image) => !restaurant.gallery || !restaurant.gallery.includes(image)
        );
        ...
        {days.map((day) => (
          <View key={day.id} style={styles.hoursRow}>
            <View style={styles.dayContainer}>
              ...
              <Switch
                value={restaurant.openingHours[day.id]?.isOpen}
                onValueChange={(value) =>
                ...
                thumbColor={
                  restaurant.openingHours[day.id]?.isOpen
                    ? theme.colors.success
                    : theme.colors.placeholder
                }
              />
              ...
              <View style={styles.hoursContainer}>
                <View style={styles.timeContainer}>
                  ...
                  <TextInput
                    ...
                    value={restaurant.openingHours[day.id]?.open}
                    onChangeText={(text) =>
                ...
                <View style={styles.timeContainer}>
                  ...
                  <TextInput
                    ...
                    value={restaurant.openingHours[day.id]?.close}
                    onChangeText={(text) =>
  ...
  const renderImagesTab = () => (
    <View style={styles.tabContent}>
      ...
      <View style={styles.imageSection}>
        ...
        >
          <Text style={[styles.imageButtonText, { color: theme.colors.white }]}>
