...
const RestaurantScreen = ({ route, navigation }) => {
  ...
  const handleAddItem = (item) => {
    ...
    const success = addItem(restaurantId, restaurant.name, cartItem);
  ...
  const shareRestaurant = async () => {
    try {
      await Share.share({
        message: `Check out ${restaurant.name} on Food Delivery App!`,
    ...
    <View style={styles.infoContainer}>
      <View style={styles.infoRow}>
        <View style={styles.infoLeft}>
          ...
          <View style={styles.ratingsRow}>
            <RatingStars rating={restaurant.rating || 0} size={16} />
      ...
      <View style={styles.detailsRow}>
        ...
        <View style={styles.detailItem}>
          ...
          <Text style={[styles.detailText, { color: theme.colors.text }]}>
            ${restaurant.minOrderAmount || 0} minimum
          </Text>
        </View>
        ...
        <>
          <View style={styles.ratingsSummary}>
            <View style={styles.ratingsBig}>
              ...
              <RatingStars rating={restaurant.rating || 0} size={20} />
              <Text
                style={[
        ...
        content={
          <View style={styles.cartDrawerContent}>
            ...
            >
              ...
              replace your current cart with items from this restaurant?
            </Text>
            <TouchableOpacity
              style={[
